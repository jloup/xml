...
func testLinkValidator(actual xmlutils.Visitor, expected xmlutils.Visitor) error {
	l1 := actual.(*Link)
	l2 := expected.(*Link)
...
func testLinkConstructor() xmlutils.Visitor {
	return NewLink()
}

func testLinkToTestVisitor(t testLink) xmlutils.TestVisitor {

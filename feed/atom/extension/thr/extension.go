...
func AddToManager(manager *extension.Manager) {
	manager.AddElementExtension("entry", _inreplyto, newInReplyToElement, xmlutils.UniqueValidator(atom.AttributeDuplicated))
	manager.AddElementExtension("entry", _total, newTotalElement, xmlutils.UniqueValidator(atom.AttributeDuplicated))
